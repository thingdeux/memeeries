...
public abstract class MemeFinderPaginateListener extends RecyclerView.OnScrollListener {
    ...
    public MemeFinderPaginateListener(GridLayoutManager gridLayoutManager) {
